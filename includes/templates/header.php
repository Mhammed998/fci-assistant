<?php
    ...
    if( $_SERVER['REQUEST_URI'] == '/newphp/login.php'){
       $class="log-page";
       $id="";
    }
    elseif($_SERVER['REQUEST_URI'] == '/newphp/home.php'){
      $class="home-page";
      $id="";
    }


    elseif($_SERVER['REQUEST_URI'] == '/newphp/profile.php'){
      $class="profile-page";
      $id="";

    }
    elseif($_SERVER['REQUEST_URI'] == '/newphp/register.php'){
      $class="reg-page";
      $id="";

    }

     elseif($_SERVER['REQUEST_URI'] == '/newphp/events.php'){
      $class="home-page";
      $id="";
