...
ob_start();
session_start();
$pageTitle="FCI-ASSISTANT | User Profile";
...
<a href="javascript:history.back()">&larr; back</a>
  ...
  <?php
   ...
   if($action == 'nothing'){
    echo '<h1 class="big-title text-center"> Member Profile </h1>';
...
<div class="img-head">
    ...
    <h3 class="memberName"><?php echo $get['fullname'] ?></h3>
      ...
      <div class="col-md-12">
         <div id="comments">
           <?php
              ...
              $comments->execute(array($memberid));
            ...
            <?php    foreach ($getcomment as $comment) {
                ...
                echo "<div class='comment'>";
                  ...
                  echo "<div class='options'>";
                   echo " <a  class='label label-danger' title='Delete' href='?action=deletec&cid=".$comment['comment_id']."'>Delete</a>";
                 echo"</div>";
